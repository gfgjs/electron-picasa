<template>
    <div class="container">
        <div class="card">
            ...
            <p>{{ contentToCopy }}</p>
            <div class="card clickable" @click="copyToClipboard">
                Click To Copy
            </div>
        </div>
        <div class="card">
            ...
            <div class="flex">
                <div class="card clickable" @click="pickItem">
                    Click To Pick File
                </div>
                <div class="card clickable" @click="showItem">
                    Click To Show File in Directory
                </div>
            </div>
        </div>
        <div class="card">
        ...
        <div class="card">
            ...
            <p>count: {{ count }}</p>
            <div class="flex">
                <div class="card clickable" @click="increment">
                    Click To Increment by Commit
                </div>
            </div>
        </div>
    </div>
